...
if args.train:
    ...
    optimizer = ptimizer = SAM(model.parameters(), base_optimizer, lr=args.lr, momentum=args.momentum, weight_decay=args.weight_decay)
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer.base_optimizer, mode='max', factor=args.gamma, patience=args.patience, threshold=0.0001, 
